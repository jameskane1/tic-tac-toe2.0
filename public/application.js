...
var removeClassSignin = function removeClassSignin() {
  $('#sign-in-submit').removeClass('gameboard');
  $('#sign-up-submit').removeClass('gameboard');
};

var addClassBoard = function addClassBoard() {
...
var gameTrackerSuccess = function gameTrackerSuccess(data) {
  $('#gamesPlayedMessage').text('This is your total games played! ' + data.games.length);
};

var gameTrackerFailure = function gameTrackerFailure(error) {
...
exports.addClassBoard = addClassBoard;
exports.removeClassSignin = removeClassSignin;
exports.newGameSuccess = newGameSuccess;
exports.newGameFailure = newGameFailure;
exports.updateGameSuccess = updateGameSuccess;
exports.updateGameFailure = updateGameFailure;
exports.startNewGame = startNewGame;
exports.gameTrackerSuccess = gameTrackerSuccess;
exports.gameTrackerFailure = gameTrackerFailure;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var winningLogic = __webpack_require__(7);
...
var setTurn = function setTurn(newTurn) {
  turn = newTurn;
};

var setBoard = function setBoard(array) {
  exports.gameBoard = gameBoard = array;
};

var executeMove = function executeMove(event) {
  ...
  var y = parseInt(event.target.id.split(',')[1]);
  var x = parseInt(event.target.id.split(',')[0]);
  var indexValue = y * 3 + x;
  ...
  api.updateGame(indexValue, turn % 2 === 0 ? 'x' : 'o', winningLogic.gameOver).then(ui.updateGameSuccess).catch(ui.updateGameFailure);
};
...
var gamesLogic = __webpack_require__(6);
var gameOver = false;

var xWins = function xWins() {
  if (gamesLogic.gameBoard[0] === 'X' && gamesLogic.gameBoard[1] === 'X' && gamesLogic.gameBoard[2] === 'X' || gamesLogic.gameBoard[0] === 'X' && gamesLogic.gameBoard[3] === 'X' && gamesLogic.gameBoard[6] === 'X' || gamesLogic.gameBoard[0] === 'X' && gamesLogic.gameBoard[4] === 'X' && gamesLogic.gameBoard[8] === 'X' || gamesLogic.gameBoard[1] === 'X' && gamesLogic.gameBoard[4] === 'X' && gamesLogic.gameBoard[7] === 'X' || gamesLogic.gameBoard[2] === 'X' && gamesLogic.gameBoard[5] === 'X' && gamesLogic.gameBoard[8] === 'X' || gamesLogic.gameBoard[2] === 'X' && gamesLogic.gameBoard[4] === 'X' && gamesLogic.gameBoard[6] === 'X' || gamesLogic.gameBoard[3] === 'X' && gamesLogic.gameBoard[4] === 'X' && gamesLogic.gameBoard[5] === 'X' || gamesLogic.gameBoard[6] === 'X' && gamesLogic.gameBoard[7] === 'X' && gamesLogic.gameBoard[8] === 'X') {
...
var oWins = function oWins() {
  if (gamesLogic.gameBoard[0] === 'O' && gamesLogic.gameBoard[1] === 'O' && gamesLogic.gameBoard[2] === 'O' || gamesLogic.gameBoard[0] === 'O' && gamesLogic.gameBoard[3] === 'O' && gamesLogic.gameBoard[6] === 'O' || gamesLogic.gameBoard[0] === 'O' && gamesLogic.gameBoard[4] === 'O' && gamesLogic.gameBoard[8] === 'O' || gamesLogic.gameBoard[1] === 'O' && gamesLogic.gameBoard[4] === 'O' && gamesLogic.gameBoard[7] === 'O' || gamesLogic.gameBoard[2] === 'O' && gamesLogic.gameBoard[5] === 'O' && gamesLogic.gameBoard[8] === 'O' || gamesLogic.gameBoard[2] === 'O' && gamesLogic.gameBoard[4] === 'O' && gamesLogic.gameBoard[6] === 'O' || gamesLogic.gameBoard[3] === 'O' && gamesLogic.gameBoard[4] === 'O' && gamesLogic.gameBoard[5] === 'O' || gamesLogic.gameBoard[6] === 'O' && gamesLogic.gameBoard[7] === 'O' && gamesLogic.gameBoard[8] === 'O') {
    exports.gameOver = gameOver = true;
    return true;
  } else {
    return false;
...
var onSignUp = function onSignUp(event) {
  ...
  api.createSignUp(data).then(ui.signUpSuccess).catch(ui.signUpFailure);
};

var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.createSignIn(data).then(ui.signInSuccess).then(ui.removeClass).then(ui.addClass).catch(ui.signInFailure);
};
...
var onSignOut = function onSignOut(event) {
  var data = getFormFields(this);
  event.preventDefault();
  api.signOut(data).then(ui.signOutSuccess).then(ui.addClassBoard).then(ui.removeClassSignin).then(function () {
...
var onNewGame = function onNewGame(event) {
  event.preventDefault();
  api.newGame(event).then(ui.newGameSuccess).then(function () {
  ...
  }).then(onGameTracker).then(function () {
    gamesLogic.setBoard([]);
  }).then(function () {
    winningLogic.gameOver = false;
  }).then(ui.startNewGame).catch(ui.newGameFailure);
};
...
var onGameTracker = function onGameTracker() {
  api.gameData().then(ui.gameTrackerSuccess).catch(ui.gameTrackerFailure);
};
...
exports.onGameTracker = onGameTracker;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
